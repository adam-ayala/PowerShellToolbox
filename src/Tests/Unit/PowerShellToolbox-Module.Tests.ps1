...
Describe 'Module Tests' -Tag Unit {
    Context "Module Tests" {
        ...
        It 'root module PowerShellToolbox.psm1 should exist' {
            $PathToModule | Should -Exist
            $? | Should -BeTrue
        } #psm1Exists
        It 'manifest should contain PowerShellToolbox.psm1' {
            $PathToManifest |
            Should -FileContentMatchExactly "PowerShellToolbox.psm1"
        } #validPSM1
